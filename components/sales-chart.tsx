...
export function SalesChart() {
	...
	const totalSales = chartRows.reduce((sum, r) => sum + rowTotal(r), 0);

	return (
		<Card className="rounded-none border-0 bg-card py-4 shadow-none ring-0 lg:col-span-3">
			<CardHeader>
				<div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
					<div className="min-w-0">
						...
						<p className="mt-1 font-medium text-xl tabular-nums">
