...
import { HouseIcon, SquaresFourIcon, ChartBarIcon, ShoppingCartIcon, FileTextIcon, UsersIcon, MegaphoneIcon, GearIcon, QuestionIcon, PulseIcon, StackIcon } from "@phosphor-icons/react";
