...
export const showcase: ShowcaseEntry[] = [
  {
    ...
    tag: "shadcn",
    description:
      "Actions with the stacked box-shadow ring, gradient sheen, state layer and press-sink.",
    preview: (
  ...
  },
  {
    ...
    tag: "shadcn",
    description:
      "Status pills. Neutral set for general use plus generated soft intents.",
    preview: (
      <div className="flex flex-wrap gap-2">
      ...
      },
      {
        ...
        node: (
          <div className="flex items-center gap-3">
            <Delta value={8.1} variant="badge">
              <DeltaIcon variant="trend" />
              <DeltaValue />
            </Delta>
            <Delta value={-8} variant="badge">
              <DeltaIcon variant="trend" />
              <DeltaValue />
            </Delta>
          </div>
  ...
  },
  {
    ...
    tag: "shadcn",
    description:
      "User/customer avatar with initials fallback. Borderless in our setup.",
    preview: (
  ...
  },
  {
    ...
    tag: "custom",
    description:
      "Metric cell: eyebrow label + caret delta on top, large value below. Optional chart.",
    preview: (
  ...
  },
  {
    ...
    tag: "custom",
    description:
      "Compact area chart: dashed grid, date axis, tooltip, thin linear stroke, gradient fill.",
    preview: (
  ...
  },
  {
    ...
    tag: "custom",
    description:
      "Raised surface that stacks sections with inset hairline dividers (no outer ring).",
    preview: (
  ...
  },
  {
    ...
    tag: "custom",
    description:
      "Frames a table with an optional header and an inset table region so borders stay off the edges and the hover keeps breathing room.",
    preview: (
      <DataTableCard
        title="Orders"
  ...
  },
  {
    ...
    tag: "shadcn",
    description:
      "Segmented and underline tab styles. Underline reads clearly on any surface.",
    preview: (
  ...
  },
  {
    ...
    tag: "shadcn",
    description:
      "List row primitive: media + title + description + actions, with inset separators.",
    preview: (
        ...
        node: (
          <Card className="overflow-hidden py-0">
            <ItemGroup>
              <DemoItem
                icon={<PackageIcon />}
                title="#3102 · Astrid Lindqvist"
                desc="3 items · Ships Jun 20"
                status="Processing"
              />
              <ItemSeparator className="mx-4 data-horizontal:w-auto" />
              <DemoItem
                icon={<TruckIcon />}
                title="#3100 · Yuki Tanaka"
                desc="5 items · Ready to ship"
                status="Packed"
              />
              <ItemSeparator className="mx-4 data-horizontal:w-auto" />
              <DemoItem
                icon={<ReceiptIcon />}
                title="#3096 · Sam Whitfield"
                desc="1 item · Payment review"
                status="On hold"
              />
            </ItemGroup>
          </Card>
  ...
  },
  {
    ...
    tag: "shadcn",
    description:
      "Raised surface (lighter card lightness + soft shadow, no outline ring).",
    preview: (
...
export function usedInHref(label: string): string | null {
  ...
  const comp = showcase.find(
    (e) => e.name === label || e.name.startsWith(label)
  )
